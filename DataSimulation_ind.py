...
param_df = pd.read_csv("outputs/Ind_raw_bla_1st_parameter_summary.csv")
...
recovered_df.to_csv("outputs/simulation/Ind_raw_bla_1st_original_parameters.csv")
...
with open("simulated_blain_1straw_ind.json", "w") as f:
...
fit = model.sample(data="simulated_blain_1straw_ind.json", chains=4, parallel_chains=4, 
...
# Load newly uploaded file to extract all required parameters
param_df = pd.read_csv("outputs/simulation/Ind_raw_bla_1st_parameter_summary.csv")
...
recovered_df.to_csv("outputs/simulation/Ind_raw_bla_1st_simulated_parameters.csv")


# 1st addit

# Load newly uploaded file to extract all required parameters
param_df = pd.read_csv("outputs/Ind_addit_bla_1st_parameter_summary.csv")
...
recovered_df.to_csv("outputs/simulation/Ind_addit_bla_1st_original_parameters.csv")
...
# Load newly uploaded file to extract all required parameters
param_df = pd.read_csv("outputs/simulation/Ind_addit_bla_1st_parameter_summary.csv")
...
recovered_df.to_csv("outputs/simulation/Ind_addit_bla_1st_simulated_parameters.csv")


# 2nd phat ppe
# Load newly uploaded file to extract all required parameters
param_df = pd.read_csv("outputs/Ind_phatppe_bla_2nd_parameter_summary.csv")
...
recovered_df.to_csv("outputs/simulation/Ind_phatppe_bla_2nd_original_parameters.csv")
...
fit = model.sample(data="simulated_blain_2ndphatppe.json", chains=4, parallel_chains=4, 
                   ...
                   seed=2025, adapt_delta=0.95, max_treedepth=15,
                   show_progress=True)
results = save_stan_outputs_and_evaaluation(fit, prefix="Ind_phatppe_bla_2nd")
# Load newly uploaded file to extract all required parameters
param_df = pd.read_csv("outputs/simulation/Ind_phatppe_bla_2nd_parameter_summary.csv")
...
recovered_df.to_csv("outputs/simulation/Ind_phatppe_bla_2nd_simulated_parameters.csv")


# 2nd mixed addit
# Load newly uploaded file to extract all required parameters
param_df = pd.read_csv("outputs/Ind_mixed_addit_bla_2nd_parameter_summary.csv")
...
recovered_df.to_csv("outputs/simulation/Ind_mixed_addit_bla_2nd_original_parameters.csv")
...
# Load newly uploaded file to extract all required parameters
param_df = pd.read_csv("outputs/simulation/Ind_mixed_addit_bla_2nd_parameter_summary.csv")
...
recovered_df.to_csv("outputs/simulation/Ind_mixed_addit_bla_2nd_simulated_parameters.csv")
